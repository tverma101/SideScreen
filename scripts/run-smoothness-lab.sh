...
# Collect raw Android render timing for one active SideScreen session. The
...
Start the intended SideScreen session first. The runner records the Android
...
mac_app="/Users/$USER/Applications/SideScreen.app"
mac_cdhash="unknown"
if [[ -e "$mac_app" ]]; then
