...
def main() -> int:
    ...
    markdown = "\n".join([
        ...
        "|---|---:|---:|---:|---:|---:|",
        f"| SideScreen CPU % | {value('sidescreen_cpu_pct', 'mean')} | {value('sidescreen_cpu_pct', 'p50')} | {value('sidescreen_cpu_pct', 'p95')} | {value('sidescreen_cpu_pct', 'p99')} | {value('sidescreen_cpu_pct', 'max')} |",
