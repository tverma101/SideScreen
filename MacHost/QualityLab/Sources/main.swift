...
private func run(_ args: [String]) throws {
    ...
    case "corpus":
        ...
        try writeJSON(CorpusManifest(generatedBy: "sidescreen-quality-lab", width: width, height: height, entries: entries), to: directory.appendingPathComponent("manifest.json"))
