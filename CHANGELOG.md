...
- Compact macOS connection status: the existing settings window now keeps readiness, waiting, connected, and permission states visible above the scroll, with a direct Start/Allow action in the window and menu bar.
